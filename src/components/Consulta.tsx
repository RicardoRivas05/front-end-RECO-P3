          ...
          <tbody>
            {datos.map((dato: DatosTabla, index: number) => (
              <tr key={index}>
                ...
                <td style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd' }}>{dato.maxValue || ''}</td>
...
//   const { maxValue, stationId, date } = datos;
//   const [idNames, setIdNames] = useState<{ [key: string]: string }>({});
...
//         <thead>
//           <tr>
//             <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd', backgroundColor: '#f2f2f2' }}>Source ID</th>
//             <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd', backgroundColor: '#f2f2f2' }}>Max Value</th>
//             <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd', backgroundColor: '#f2f2f2' }}>Max Date</th>
//           </tr>
//         </thead>
//         <tbody>
//           <tr>
//             <td style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd' }}>{maxValue}</td>
//             <td style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #ddd' }}>{idNames[stationId]}</td>
