...
export const TableForm: React.FC = () => (
  <>
    <Row>
      <Col span={12}>
        <Divider/>
        <Table style={{ width: '90%', margin: 'auto' }} columns={columns} dataSource={data} pagination={false}/>
      </Col>
      <Col span={12}>
      <Divider/>
        <Table style={{ width: '90%', margin: 'auto' }} columns={columns2} dataSource={data2} pagination={false}/>
      </Col>
    </Row>
    <Row>
      <Col span={24}>
